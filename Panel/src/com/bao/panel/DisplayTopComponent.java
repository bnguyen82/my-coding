 ...
 */
@ConvertAsProperties(dtd = "-//com.bao.panel//Display//EN",
autostore = false)
@TopComponent.Description(preferredID = "DisplayTopComponent",
//iconBase="SET/PATH/TO/ICON/HERE", 
persistenceType = TopComponent.PERSISTENCE_ALWAYS)
@TopComponent.Registration(mode = "output", openAtStartup = true)
@ActionID(category = "Window", id = "com.bao.panel.DisplayTopComponent")
@ActionReference(path = "Menu/Window" /*, position = 333 */)
@TopComponent.OpenActionRegistration(displayName = "#CTL_DisplayAction",
preferredID = "DisplayTopComponent")
